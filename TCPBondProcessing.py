...
for T in Temperatures:
    for P in Pressures:
        print("F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/".format(T, P))
        # sys.path.append("/home/carlos/anaconda3/lib/python3.7/site-packages")
        sys.path.append(
            "F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/processed/".format(T, P))
        import numpy as np
        ...
        if __name__ == "__main__":
            ...
            dir = 'F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/'.format(T, P)  # CHANGEHERE
            directories = [dir]
            ...
            for border in borders:
                for ind, direct in enumerate(directories):
                    ...
                    datafile = 'F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/48_TCP_Fe3C_010.data'.format(
                        T, P)  # CHANGEHERE
                    starting_bfile = 'F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/48_TCP_Fe3C_010-BONDS.data'.format(
                        T, P)  # CHANGEHERE

                    start = time.time()
                    tal = Networkgen(datafile, starting_bfile)
                    tal.ovito_mols(
                        fout='F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/'.format(
                    ...
                    # fout_CH='F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/'.format(T, P)+system+'C_2-H_1'+str(border)
                    ...
                    fout = 'F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/processed/'.format(
                        T, P) + system + '_b' + str(  # CHANGEHERE
                        border)
                    fout_new = 'F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/processed/'.format(
                        T, P) + system + '_new_b' + str(  # CHANGEHERE
                        border)
                    fout_start = 'F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/processed/'.format(
                    ...
                    path_name_data_out = "F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/ovito_datafiles/".format(
                        T, P) + system + '_'  # CHANGEHERE

                    datafile_for_header = '48_TCP_Fe3C_010.data'
                    ...
                    fout_intact = 'F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/processed/'.format(
        ...
        while Index < NumberofBondTypes:
            ...
            plt.savefig(
                'F:/PhD/TCPDecompositionExperiments/Completed/FeC/{}/{}/processed/'.format(T, P) + GRAPHNAME + '.png')
            # plt.show()
            Index += 1
